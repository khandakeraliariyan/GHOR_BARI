...
const LocateButton = ({ setValue, setPosition }) => {
    ...
    return (
        <button
            type="button"
            onClick={locateMe}
            className="absolute z-[1000] top-3 right-3 bg-white/70 backdrop-blur-md px-3 py-1.5 rounded shadow text-sm hover:bg-white/80 transition-all border border-gray-200"
        >
            📍 Locate Me
        </button>
    );
