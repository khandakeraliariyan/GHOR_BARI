    ...
    return (
        <section className="bg-gray-100 py-12 md:py-24 px-4">
            <div className="w-11/12 mx-auto">
                {/* Main Card Container */}
                <div className="relative overflow-hidden bg-white rounded-lg shadow-xl border border-white group">
                    ...
                    <div className="relative z-10 py-12 md:py-16 px-6 md:px-12 flex flex-col items-center text-center">
                        ...
                        <div className="mb-6 p-4 bg-orange-50 text-orange-500 rounded-md shadow-sm group-hover:scale-110 group-hover:bg-orange-500 group-hover:text-white transition-all duration-500">
                            <Crown size={32} />
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                            ...
                            <Link
                                to="/properties"
                                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-white text-orange-600 font-bold rounded-md border-2 border-orange-100 shadow-sm hover:shadow-orange-200/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer"
                            >
                                Browse Properties
                                <ArrowRight size={20} />
                            </Link>
                            ...
                            <Link
                                to="/list-property"
                                className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-slate-900 text-white font-bold rounded-md hover:bg-black hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer"
                            >
                                <PlusCircle size={20} />
                                List Your Property
                            </Link>
